        ...
        <div class="modal-content">
            <form action="">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pil bg-light text-dark mb-3 text-wrap lh-base">Note: Your details must
                        match
                        with your ID(Aadhar Card, Passport , Driving Liscense etc) that will be required during
                        check-in</span>
                    <div class="container-fluid">
                        <div class="row">
