            ...
            <div class="col-lg-9 col-md-12 px-4">
                ...
                while ($room_data = mysqli_fetch_assoc($room_res)) {
                    ...
                    while ($fea_row = mysqli_fetch_assoc($fea_q)) {
                        $features_data .= "<span class='badge rounded-pil bg-light text-dark text-wrap '>$fea_row[name]
                        </span>";
                    }
                    ...
                    while ($fac_row = mysqli_fetch_assoc($fac_q)) {
                        $facilities_data .= "<span class='badge rounded-pil bg-light text-dark text-wrap '>$fac_row[name]
                        </span>";
                    }
